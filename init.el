...
(custom-set-faces
 ...
 '(font-lock-comment-delimiter-face ((t (:foreground "#606060" :slant italic))))
 '(font-lock-comment-face ((t (:foreground "#606060" :slant italic))))
 '(font-lock-constant-face ((t (:foreground "#ff0055" :weight semi-bold))))
 '(font-lock-doc-face ((t (:foreground "#ffffff" :weight bold))))
 '(font-lock-function-name-face ((t (:foreground "#cc80ff" :weight extra-bold))))
 '(font-lock-keyword-face ((t (:foreground "#cc80ff" :weight bold))))
 ...
 '(font-lock-variable-name-face ((t (:foreground "#aa77ff"))))
